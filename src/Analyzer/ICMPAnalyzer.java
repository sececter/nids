 ...
 * @author suman
 */
public class ICMPAnalyzer extends JpacketAnalyzer {
...
private static final String[] valueNames={
	...
	public void analyze(Packet p){
		...
		if(icmp.type==13 || icmp.type==14){
			values.put(valueNames[6],new Long(icmp.orig_timestamp));//original timestamp
			values.put(valueNames[7],new Long(icmp.recv_timestamp));//receive timestamp
			values.put(valueNames[8],new Long(icmp.trans_timestamp));//transmission timestamp
		}
	}
